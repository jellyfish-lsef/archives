...
import { Branch, pathsToTree } from "../../helpers.js";
...
export class ScriptsSidebar extends Component<unknown, {paths: string[], open:boolean}> {
    update() {
    ...
    branchToHtml(branch: Branch):(VNode<any>[] | VNode<any>)[] {
