...
export default async function register() {
    ...
    try {
        ...
        services = [];
        enums = [];
        let f = await fetch("https://raw.githubusercontent.com/CloneTrooper1019/Roblox-Client-Tracker/roblox/API-Dump.json");
        ...
        for (let element of json.Enums) { enums.push(element.Name); }
