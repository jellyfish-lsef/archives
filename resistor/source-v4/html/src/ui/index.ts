...
import { ApplicationState, Page } from "../types.js";
...
class Application extends Component<unknown, ApplicationState> {
    constructor() {
        super();
        this.state = {
            page: "editor",
        ...
        MessageBus.on("titleChange", (title: string) => this.setState({ title }));
        MessageBus.on("setPage", (page: Page) => this.setState({ page }));
    }
    render() {
        return html`
            <div class="app">
