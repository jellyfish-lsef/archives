...
electron-packager . Fluidity --exclude=.git --app-version "3.1.0" --platform darwin --out ./builds --overwrite --icon ./logo.icns --asar --app-copyright "(c)" --app-bundle-id com.fluidity.m.capacitor --darwin-dark-mode-support
