...
<div class="content" id="aboutPage">
    <section id="aboutPageHeader">
        ...
        <div>
            ...
            <h3 id="aboutCopyright">Revolutionising scripting since 2017.</h3>
            <h3 id="aboutCopyright">Version ${require("../package.json").version} </h3>
        </div>
    </section>

    <section id="aboutPageLinks">
        <a href="javascript:void" onclick=${() => this.openDashboard("https://dashboard.fluidity.developer.com/settings")}>
            <i class="material-symbols">account_circle</i>
            Manage Account
        </a>
        •
        <a href="https://dev.fluidity.developer.com/docs/macOS/getting/started/welcome" target="_blank">
            <i class="material-symbols">menu_book</i>
            Documentation
        </a>
        <br />
        <a href="javascript:void" onclick=${() => this.openDashboard("https://dashboard.fluidity.developer.com/support")}>
            <i class="material-symbols">support_agent</i>
            Support
        </a>
        •
        <a href="https://github.com/jellyfish-lsef/fdty-bugtracker/issues" target="_blank">
    ...
    <section id="aboutPageOptions">
        ...
        <div class="aboutPageOption">
            <div class="aboutPageOptionBar">
                <div class="aboutPageOptionTitle">
                    <i class="material-symbols">blur_on</i> Vibrancy
                </div>
                <div class="aboutPageOptionControl">
                    <input type="checkbox" id="aboutPageOptionControl" checked=${settings.vibrant} onchange=${(e: Event) => settings.vibrant = (e.target as HTMLInputElement).checked} />
                </div>
            </div>
            <div class="aboutPageOptionDescription">
                Applies a 'frosted glass' effect. Turning off can improve performance.
                <br/>
                <b><i class="material-symbols">warning</i> You must restart Fluidity for this to take effect.</b>
            </div>
        </div>
        <div class="aboutPageOption">
            <div class="aboutPageOptionBar">
        ...
        <div class="aboutPageOption" style="display: ${this.state.cameraStatus == "granted" ? "none" : "block"}">
            <div class="aboutPageOptionBar">
                <div class="aboutPageOptionTitle">
                    <i class="material-symbols">camera</i> Request Camera Permissions
                </div>
                <div class="aboutPageOptionControl">
                    ${this.state.microphoneStatus == "denied" ?
        html`<a href="#" onclick=${async() => shell.openPath("/System/Library/PreferencePanes/Security.prefPane")}>
        ...
        html`
                <a href="#" onclick=${async() => this.setState({ cameraStatus: await ipcRenderer.invoke("req-cam-perms", true) })}>
                        Request Permission <i class="material-symbols">task_alt</i>
                    </a>`}
                </div>
            </div>
            <div class="aboutPageOptionDescription">
            If you are experiencing crashes while face tracking is enabled, you may need to request camera permissions for Fluidity.
            <br/>
            <b><i class="material-symbols">privacy_tip</i> This permission is only asked so that it can be used for the game's face tracking, Fluidity respects your privacy and will NEVER use it for any other reasons.</b>
            </div>
        </div>
