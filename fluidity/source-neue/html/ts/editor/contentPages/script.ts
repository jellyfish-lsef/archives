...
export class ScriptContent extends Component<{uri: monaco.Uri}, {info?: ScriptLibraryScriptInfo, actionInProgress: boolean}> {
        ...
        if (!this.state.info) {
            ...
            return html`<div class="contentPage content-script">
                <div class="contentPageHeader glowing">
                    <div class="contentPageHeaderImage" style="background-image: url(${icon || "https://fluidity.developer.com/assets/img/script.png"})" alt="" />
                    ...
                    <div class="contentPageHeader">
                        ...
                        <div class="contentPageHeaderInfo">
                            ...
                            <h2>
                                ...
                                </a> • ${this.state.info.total_saves.toLocaleString()} saves • ${this.state.info.category} • created ${dateFormatter.format(new Date(this.state.info.created_at))} ${this.state.info.created_at !== this.state.info.updated_at ? " • updated " + dateFormatter.format(new Date(this.state.info.updated_at)) : ""}
                            </h2>
                        </div>
                    </div>
    ...
    copyLink() {
        clipboard.writeText("https://dashboard.fluidity.developer.com/catalogue?scriptID=" + this.state.info!.id);
    }
    report() {
        // TODO: reporting
    }
