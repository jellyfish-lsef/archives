...
export class UserContent extends Component<{uri: monaco.Uri | null}, {userInfo?: UserProfile, actionInProgress: boolean}> {
    render() {
        ...
        const badges = [];
        if (this.state.userInfo?.staff) badges.push(h("img", { style: "height:24px;", alt: "Fluidity Staff", src: "./assets/img/logo.svg" }));
        ...
        if (this.state.userInfo?.has_m) badges.push(h("img", { style: "padding-left: 0.2em; height:24px;", alt: "Owns Fluidity (macOS)", src: "./assets/img/finder-mono.svg" }));
