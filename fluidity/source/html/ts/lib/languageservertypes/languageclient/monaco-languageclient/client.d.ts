import { CallHierarchyProvider, CancellationToken, CodeAction as VCodeAction, CodeActionContext as VCodeActionContext, CodeActionProvider, CodeLens as VCodeLens, Command as VCommand, CompletionContext as VCompletionContext, CompletionItem as VCompletionItem, CompletionItemProvider, CompletionList as VCompletionList, DeclarationProvider, Definition as VDefinition, DefinitionLink as VDefinitionLink, DefinitionProvider, Diagnostic as VDiagnostic, DiagnosticCollection, Disposable, DocumentColorProvider, DocumentFormattingEditProvider, DocumentHighlight as VDocumentHighlight, DocumentHighlightProvider, DocumentLink as VDocumentLink, DocumentLinkProvider, DocumentRangeFormattingEditProvider, DocumentSymbol as VDocumentSymbol, DocumentSymbolProvider, FileCreateEvent, FileDeleteEvent, FileRenameEvent, FileSystemWatcher as VFileSystemWatcher, FileWillCreateEvent, FileWillDeleteEvent, FileWillRenameEvent, FoldingRangeProvider, FormattingOptions as VFormattingOptions, Hover as VHover, HoverProvider, ImplementationProvider, LinkedEditingRangeProvider, Location as VLocation, OnTypeFormattingEditProvider, OutputChannel, Position as VPosition, ProviderResult, Range as VRange, ReferenceProvider, RenameProvider, SelectionRangeProvider, SignatureHelp as VSignatureHelp, SignatureHelpContext as VSignatureHelpContext, SignatureHelpProvider, SymbolInformation as VSymbolInformation, TextDocument, TextDocumentChangeEvent, TextDocumentWillSaveEvent, TextEdit as VTextEdit, TypeDefinitionProvider, Uri, WorkspaceEdit as VWorkspaceEdit, WorkspaceFolder as VWorkspaceFolder, WorkspaceSymbolProvider } from "vscode";
import { CallHierarchyPrepareRequest, CancellationStrategy, ClientCapabilities, CodeActionRequest, CompletionRequest, DeclarationRequest, DefinitionRequest, DidChangeTextDocumentNotification, DidCloseTextDocumentNotification, DidCreateFilesNotification, DidDeleteFilesNotification, DidOpenTextDocumentNotification, DidRenameFilesNotification, DidSaveTextDocumentNotification, DocumentColorRequest, DocumentFormattingRequest, DocumentHighlightRequest, DocumentLinkRequest, DocumentOnTypeFormattingRequest, DocumentRangeFormattingRequest, DocumentSelector, DocumentSymbolRequest, Event, FileEvent, FileOperationRegistrationOptions, FoldingRangeRequest, GenericNotificationHandler, GenericRequestHandler, HoverRequest, ImplementationRequest, InitializeError, InitializeParams, InitializeResult, LinkedEditingRangeRequest, Message, MessageReader, MessageSignature, MessageWriter, NotificationHandler, NotificationHandler0, NotificationType, NotificationType0, ProgressToken, ProgressType, ProtocolNotificationType, ProtocolNotificationType0, ProtocolRequestType, ProtocolRequestType0, ReferencesRequest, RegistrationType, RenameRequest, RequestHandler, RequestHandler0, RequestType, RequestType0, ResponseError, SelectionRangeRequest, SemanticTokensRegistrationType, ServerCapabilities, ShowDocumentParams, ShowDocumentRequest, ShowDocumentResult, SignatureHelpRequest, StaticRegistrationOptions, TextDocumentRegistrationOptions, Trace, TypeDefinitionRequest, WillCreateFilesRequest, WillDeleteFilesRequest, WillRenameFilesRequest, WillSaveTextDocumentNotification, WillSaveTextDocumentWaitUntilRequest, WorkDoneProgressBegin, WorkDoneProgressEnd, WorkDoneProgressReport, WorkspaceSymbolRequest } from "vscode-languageserver-protocol";
